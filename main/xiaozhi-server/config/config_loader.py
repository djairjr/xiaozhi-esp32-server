...
def get_config_from_api(config):
    ...
    # The configuration of the server is subject to local
    ...
    # If the server does not have prompt_template, read from the local configuration
...
def ensure_directories(config):
    ...
    # Create a model directory based on selected_module
