...
class ASRProvider(ASRProviderBase):
    ...
    async def receive_audio(self, conn, audio, audio_have_voice):
        ...
        # Handling complete speech segments when there is no audio data
        ...
        if audio_have_voice and self.asr_ws is None and not self.is_processing:
            try:
                ...
                try:
                    ...
                    logger.bind(tag=TAG).info(f"Initialization response received: {result}")
                ...
                # Start an asynchronous task that receives ASR results
            ...
            while self.asr_ws and not conn.stop_event.is_set():
                ...
                try:
                    ...
                    if "payload_msg" in result:
                        ...
                        # Check whether it is error code 1013 (no valid voice)
                        if "code" in payload and payload["code"] == 1013:
                            # Process silently, no error logs are recorded
                            continue
                        ...
                        if "result" in payload:
                            ...
                            if (
                                ...
                                logger.bind(tag=TAG).error(f"Recognize text: empty")
                                self.text = ""
