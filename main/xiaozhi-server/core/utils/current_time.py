"""time tools module
Provide unified time acquisition function"""
...
def get_current_lunar_date() -> str:
    ...
    try:
        ...
        return "Failed to obtain lunar calendar"


def get_current_time_info() -> tuple:
    """Get current time information
    Returns: (current time string, today's date, today's week, lunar date)"""
