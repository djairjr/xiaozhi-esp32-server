...
def decode_opus_from_file(input_file):
    """Decodes Opus data from a p3 file and returns a list of Opus packets and their total duration."""
    opus_datas = []
    total_frames = 0
    sample_rate = 16000  # file sampling rate
    ...
    with open(input_file, 'rb') as f:
        while True:
            ...
            # Read Opus data according to the length specified by the header
...
def decode_opus_from_bytes(input_bytes):
    """Decodes Opus data from p3 binary data and returns a list of Opus packets and their total duration."""
    import io
    opus_datas = []
    total_frames = 0
    sample_rate = 16000  # file sampling rate
