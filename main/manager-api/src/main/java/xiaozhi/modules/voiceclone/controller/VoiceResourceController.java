...
public class VoiceResourceController {
    ...
    @GetMapping("{id}")
    @Operation(summary = "Get timbre resource details")
    @RequiresPermissions("sys:role:superAdmin")
    ...
    @PostMapping
    @Operation(summary = "Added sound resource")
    @RequiresPermissions("sys:role:superAdmin")
    ...
    @DeleteMapping("/{id}")
    @Operation(summary = "Delete sound resources")
    @RequiresPermissions("sys:role:superAdmin")
    ...
    @Operation(summary = "Get the timbre resource list based on user ID")
    ...
    @Operation(summary = "Get TTS platform list")
    @RequiresPermissions("sys:role:superAdmin")
