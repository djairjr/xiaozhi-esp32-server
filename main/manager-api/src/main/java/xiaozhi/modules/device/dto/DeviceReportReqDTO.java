...
@Setter
@Getter
@Schema(description = "Device firmware information reporting request body")
public class DeviceReportReqDTO implements Serializable {
    private static final long serialVersionUID = 1L;
    // region entity_properties
    @Schema(description = "Board firmware version number")
    private Integer version;

    @Schema(description = "Flash memory size (unit: bytes)")
    ...
    @Schema(description = "Board configuration information")
    ...
    public static class ChipInfo {
        ...
        @Schema(description = "Chip function flag bit")
        private Integer features;
    }

    @Getter
    @Setter
    @Schema(description = "Board compilation information")
    public static class Application {
        @Schema(description = "name")
        private String name;

        @Schema(description = "Application version number")
        ...
        @Schema(description = "ELF document SHA256 verification")
    ...
    public static class BoardInfo {
        ...
        @Schema(description = "Wi-Fi signal_strength（RSSI）")
