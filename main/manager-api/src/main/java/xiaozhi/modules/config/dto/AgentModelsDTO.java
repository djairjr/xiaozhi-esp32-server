...
@Data
@Schema(description = "Get the agent model configuration DTO")
public class AgentModelsDTO {
    ...
    @NotNull(message = "The model instantiated by the client cannot be empty")
    @Schema(description = "Client-instantiated model")
