...
@Tag(name = "Intelligent voiceprint management")
@AllArgsConstructor
@RestController
...
public class AgentVoicePrintController {
    ...
    @PostMapping
    @Operation(summary = "Create the agent’s voiceprint")
    ...
    @PutMapping
    @Operation(summary = "Update the corresponding voiceprint of the agent")
    @RequiresPermissions("sys:role:normal")
    ...
    @DeleteMapping("/{id}")
    @Operation(summary = "Delete the voiceprint corresponding to the agent")
    @RequiresPermissions("sys:role:normal")
    ...
    @GetMapping("/list/{id}")
    @Operation(summary = "Get the voiceprint list of user-specified agents")
    @RequiresPermissions("sys:role:normal")
