...
public class TimbreController {
    ...
    @Parameters({
            @Parameter(name = "ttsModelId", description = "Corresponds to TTS model primary key", required = true),
    ...
    @PutMapping("/{id}")
    @Operation(summary = "Tone modification")
    @RequiresPermissions("sys:role:superAdmin")
    ...
    @PostMapping("/delete")
    @Operation(summary = "Sound deletion")
    @RequiresPermissions("sys:role:superAdmin")
